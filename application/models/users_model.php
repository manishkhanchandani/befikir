...
class Users_model extends CI_Model
{
	...
	public function create_fb_user($data=array())
	{
		...
		$return = array('uid' => $id, 'username' => $data['name'], 'name' => $data['name'], 'email' => $data['email'], 'id' => $data['id'], 'gender' => $data['gender'], 'timezone' => $data['timezone'], 'location' => $data['location']['name'], 'lastlogin' => date('Y-m-d H:i:s'), 'pic' => 'https://graph.facebook.com/'.$data['id'].'/picture?type=large');
		return $return;
	}//end create_fb_user()
