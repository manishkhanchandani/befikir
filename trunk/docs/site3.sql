...
insert  into `users`(`uid`,`username`,`email`,`password`,`created`,`updated`,`lastlogin`,`status`,`name`,`profile_pic`,`dob`,`gender`,`timezone`,`location`,`site_id`) values (1,NULL,'naveenkhanchandani@gmail.com',NULL,'2011-03-13 06:08:20','2011-03-14 13:21:40','2011-03-14 13:21:40',1,'Manish Khanchandani','https://graph.facebook.com/748940976/picture?type=large','1974-06-05','male',-7,'Orlando, Florida',1);
